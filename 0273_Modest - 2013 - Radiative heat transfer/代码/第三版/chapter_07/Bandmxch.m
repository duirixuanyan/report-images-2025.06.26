...
Bandwl(1) = 4.0;                    % wavelength in micron
...
HOs(1,2)  = 500.0*bbfn(4.*5762);
HOs(2,2)  = 500.0 - HOs(1,2);                     % direct solar irradiation
EPS(1,2)  = 0.1;
RHOs(1,2) = 0.9;
EPS(2,2)  = 0.8;
RHOs(2,2) = 0.2;
...
[q2, T2] = BANDAPP(iclsd, A, Bandwl, EPS, RHOs, HOs, Fs, id, q, T);
% Output
