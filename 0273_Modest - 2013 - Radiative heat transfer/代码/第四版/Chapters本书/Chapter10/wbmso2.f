      SUBROUTINE WBMSO2(TEMP,PSIE,PHIE)
C THIS ROUTINE CALCULATES THE LINE OVERLAP FUNCTION GAMMA (PHI/SQRT(T)) 
C AND STRENGTH FUNCTION ALPHA (PSI*) AS FUNCTION OF TEMPERATURE, 
C THEN NORMALIZES THEM WITH THE VALUE AT 100K 
C *** SULFUR DIOXIDE S02 ***
...
C 
C SCAN OVER THE 5 IMPORTANT BANDS 
C
      DO 2000 IB=1,5
      M=3
      ETA(1)=1151.D0
