## 2\. Basic Usage of GreenLight[](#2-basic-usage-of-greenlight)
...
### 2.1 Import Necessary Modules[](#21-import-necessary-modules)
...
### 2.2 Set Basic Parameters[](#22-set-basic-parameters)
...
### 2.3 Create a GreenLight Model Instance[](#23-create-a-greenlight-model-instance)
...
### 2.4 Initialize Model State and Parameters[](#24-initialize-model-state-and-parameters)
...
### 2.5 Run Model Simulation[](#25-run-model-simulation)
...
### 2.6 Output Results[](#26-output-results)
...
### 2.7 Complete Code Example[](#27-complete-code-example)
...
[1\. Installation](https://botanicbyte.com/Tutorial/Installation "1. Installation")[3\. Reinforcement Learning Environment](https://botanicbyte.com/Tutorial/GreenhouseEnv "3. Reinforcement Learning Environment")